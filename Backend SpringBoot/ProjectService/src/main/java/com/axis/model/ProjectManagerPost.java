...
public class ProjectManagerPost {
	...
	public String toString() {
		return "ProjectManagerPost [pmng_name=" + pmng_name + ", pmng_desg=" + pmng_desg + ", pmng_email=" + pmng_email
				+ ", pmng_contact=" + pmng_contact + ", pmng_exp=" + pmng_exp + ", pmng_salary=" + pmng_salary + ", pmng_propic=" + pmng_propic + "]";
	}
