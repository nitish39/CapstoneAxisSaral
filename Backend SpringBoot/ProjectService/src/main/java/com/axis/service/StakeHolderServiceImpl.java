...
//	
//    public String deleteStakeholder1(int sthd_id) {
//	Optional<StakeHolder> stakeHolder = stakeHolderRepository.findById(sthd_id);
//	StakeHolder StakeholderDelete = stakeHolder.orElse(null);
//	if(StakeholderDelete==null) {
//	return "Id provided is not Valid !!";
//	}
//	else {
//		stakeHolderRepository.delete(StakeholderDelete);
...
//	}
	...
	@Override
	public String deleteStakeholder(int sthd_id) {
		// TODO Auto-generated method stub
		return null;
	}
}
