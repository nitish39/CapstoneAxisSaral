...
public interface EmployeeRepository extends JpaRepository<Employee, Integer>{
	...
	public List<Employee> getEmployeeR(@Param("value")String value);
	 ...
	 @Query(value = "SELECT * FROM employee WHERE project_proj_id = :proj_id", nativeQuery = true)
	    public List<Employee> getAllByProjId(@Param("proj_id") int projId);	
	 
	 @Query(value = "SELECT * FROM employee WHERE active= 'active'",nativeQuery = true)
