...
public Employee postEmployee(@RequestBody EmployeePost employeePost) {
return employeeService.postEmployee(employeePost);
...
public void deleteEmployee(@PathVariable("empl_id")int empl_id) {
employeeService.deleteEmployee(empl_id);
}

@PutMapping("/updated/empl_id")
public void updateEmployee(@RequestBody Employee employeePost) {
employeeService.UpdateEmployee(employeePost);
}
